...
var small_door_below = {
  onPlace(arg0, arg1) {
    ...
    dimension.runCommand(
      "setblock " + x + " " + (y + 1) + " " + z + ' scp:small_door_upper["door:open"="false","minecraft:cardinal_direction"="' + face + '"]'
    );
  },
  onPlayerInteract(arg0, arg1) {
    const block = arg0.block;
...
var small_door_upper = {
  onPlayerInteract(arg0, arg1) {
  }
};

// scripts/main.ts
system2.beforeEvents.startup.subscribe((t) => {
